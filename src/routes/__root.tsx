...
import { fetchRootAuth } from "@/lib/api/auth.functions";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    ...
    scripts: [
      {
        src: "https://www.googletagmanager.com/gtag/js?id=G-MDNW9YKFDL",
        async: true,
      },
      {
